# Snakemake workflow: snakemake_workflow

[![Snakemake](https://img.shields.io/badge/snakemake-≥5.3.0-brightgreen.svg)](https://snakemake.bitbucket.io)
[![Build Status](https://travis-ci.org/snakemake-workflows/snakemake_workflow.svg?branch=master)](https://travis-ci.org/snakemake-workflows/snakemake_workflow)
...
If you simply want to use this workflow, clone the [latest release](https://github.com/bfairkun/snakemake_workflow).
